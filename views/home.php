		...
		<div class="carousel-inner" role="listbox">
			<?php foreach($carouselItems as $carouselItem): ?>
				<div class="<?php if($carouselItem['slideNumber'] == "1") {echo "item active";} else {echo "item";} ?>">
					<img src="/bubbaLyrics/cms/images/<?php echo htmlspecialchars($carouselItem['carouselPictureLink'], ENT_QUOTES, 'UTF-8'); ?>" alt="<?php echo htmlspecialchars($carouselItem['pictureDescription'], ENT_QUOTES, 'UTF-8'); ?>" width="800" height="500" />
...
<div id="accordion">
	...
	<div>
		...
		<div class="col-md-4">
			<div class="imgAbt">
				<img src="/bubbaLyrics/cms/images/<?php echo htmlspecialchars($articleItem['articlePictureLink'], ENT_QUOTES, 'UTF-8'); ?>" alt="<?php echo htmlspecialchars($articleItem['articlePictureDescription'], ENT_QUOTES, 'UTF-8'); ?>" width="300" height="250" />
			</div>
		</div>
	</div>
	<?php endforeach; ?>
